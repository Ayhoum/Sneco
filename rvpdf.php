...
<div class='row'>
    <table cellspacing=\"9\" style=\"border-collapse:collapse;border-spacing:0;width: 100%;\">
        <tbody>
        <tr>
            <td colspan=\"4\" style=\"padding: 10px 18px;background: #023560;width: 40%;\"><p class=\"text-center\" style=\"color: #fff;font-weight: 800;margin: 0;font-size: 30px;\">Receipt Voucher</p></td>
            <td colspan=\"1\" style=\"padding: 10px 18px;background: #fff;width: 5%;\"></td>
            <td colspan=\"2\" style=\"padding: 10px 18px;background: #023560;width: 25%;\"><p style=\"color: #fff;font-weight: 800;margin: 0;\"><span style=\"font-weight: 700;font-size: 15px;\">Cash Receipt No.</span><br>SNE-RV-201707-001</p></td>
...
<div class='row'>
    <table cellspacing=\"7\" style=\"border-collapse:collapse;border-spacing:0;width: 100%;\">
        <tbody>
        <tr>
            <td colspan=\"1\" style=\"padding: 10px 18px;background: #fff;float: left;width: 100%;\"><p class=\"text-center\" style=\"font-weight: 700;margin: 0;font-size:11px;\">Cash Received From _______________________________________________ of € _________________</p></td>
        </tr>
        <tr>
