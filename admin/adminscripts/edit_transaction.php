...
while($row = mysqli_fetch_assoc($select_trans_by_id)){
    ...
    if(isset($_POST['Update'])){
        ...
        $seName       = mysqli_real_escape_string($mysqli,$seName);
        $saName       = $_POST['Sender_aName'];
        $saName       = mysqli_real_escape_string($mysqli,$saName);
        ...
        $reName       = mysqli_real_escape_string($mysqli,$reName);
        $raName       = $_POST['Receiver_aName'];
        $raName       = mysqli_real_escape_string($mysqli,$raName);
        ...
        $sentAmount = mysqli_real_escape_string($mysqli,$sentAmount);
