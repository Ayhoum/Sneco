...
<div id="sidebar"><a href="admin_index.php" class="visible-phone"><i class="fa fa-tachometer"></i> Dashboard</a>
    <ul>
        ...
        <li class="submenu"> <a href="#"><i class="fa fa-pencil"></i> <span>Invoices</span></a>
            <ul>
                <li><a href="agentscripts/invoices.php">Current Invoices</a></li>
                <li><a href="agentscripts/add_invoice.php">Add Invoice</a></li>
            </ul>
        </li>
</div>
<!--sidebar-menu-->
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="Sender_eName" id="Sender_eName" required>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Name (Arabic)</label>
                            <div class="controls">
                                <input type="text" name="Sender_aName" id="Sender_aName" required>
                            </div>
                        </div>
                        <div class="control-group">
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <div class="control-group">
                            <label class="control-label">Name (English)</label>
                            <div class="controls">
                                <input type="text" name="Receiver_eName" id="Receiver_eName" required />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Name (Arabic)</label>
                            <div class="controls">
                                <input type="text" name="Receiver_aName" id="Receiver_aName" required />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Street Name</label>
                    ...
                    <div class="widget-box">
                        ...
                        <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input  type="text" name="Totalg" id="Totalg" value=" " readonly required />
                                </div>
                            </div>
