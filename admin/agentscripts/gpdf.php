...
<table class="tg">
    ...
    <tr>
        <td class="tg-031e" colspan="4"><div style="border-radius:12px 12px 0 0;;font-weight: 800;font-size: 14px;color: #FFF;padding-top: 9px;padding-bottom: 1px;width:100%;text-align: center;background: #023560;"><p><span style="font-size: 16px">Transaction Details</span></p></div>
            ...
            <div style="width: 100%;height: 50px;">
            <div style="margin-left: 15px;height: 40px;float: left;width: 32%;line-height: 1.5em;color: #000;font-size: 10px;"><p><span style="font-weight: 600;">Payout Amount:</span> $amount $payment_currency<br><span style="font-weight: 600;">Total Amount:</span> $total_amount_rate $current_currency</p></div>
    ...
    <tr>
        ...
        <div style="margin-left: 15px;height: 40px;float: left;width: 47%;line-height: 1.5em;color: #000;font-size: 10px;"><p><br><span style="font-weight: 600;">Name in Arabic:</span> أيهم<br><span style="font-weight: 600;">ID Type:</span> $sender_idtype<br><span style="font-weight: 600;">Exp. Date:</span> $sender_expiary<br><br><span style="font-weight: 600;">House No.:</span> $sender_hn<br><span style="font-weight: 600;">City:</span> $sender_city<br><br><span style="font-weight: 600;">Email:</span> $sender_email</p></div>
        </div>
        </div>
        </td>
...
$total_amount_rate = $total_amount + $rate;
