		...
		<div class="side-panel-wrap">
			...
			<div class="widget widget_links clearfix">
				...
				<div style="font-size: 14px; line-height: 1.7;">
					...
					<abbr title="Phone Number">Phone:</abbr> +31657966657<br>
                    ...
                    <div class="section nomargin">
                        <div class="container clearfix">
                            <div class="divcenter center" style="max-width: 900px;">
                                ...
                                <h2 class="nobottommargin t300 ls1">A worldwide business services</h2>

                                <p class="divcenter nobottommargin t300 ls1">In SENCO we introduce to our clients the best service. We do our best to make our customers happy and satisfied. Our services help the customer to reach out the world while they browse the internet. </p>

                                <p class="bottommargin t300 ls1"><a href="#" data-scrollto="#section-services" data-easing="easeInOutExpo" data-speed="1250" data-offset="70" class="more-link">Learn more <i class="icon-angle-right"></i></a></p><br><br>
                            </div>
                        </div>
                    </div>
                </div>
...
<!--                    <div class="container clearfix">-->
<!---->
<!--                        <h2 class="divcenter font-body nobottommargin t300 ls1" style="max-width: 700px; font-size: 40px; color: #0e0e0e">A worldwide business services</h2>-->
<!---->
<!--                        <p class="lead divcenter nobottommargin t300 ls1" style="max-width: 800px; color: #0b0b0b">In SENCO we introduce to our clients the best service. We do our best to make our customers happy and satisfied. Our services help the customer to reach out the world while they browse the internet. </p>-->
<!---->
<!--                        <p class="nobottommargin t300 ls1" style="font-size: 16px;"><a href="#" data-scrollto="#section-services" data-easing="easeInOutExpo" data-speed="1250" data-offset="70" class="more-link">Learn more <i class="icon-angle-right"></i></a></p>-->
<!---->
<!--                        <div class="clear"></div>-->
<!---->
<!--                    </div>-->
                    ...
                    <div class="section parallax nomargin dark" style="background-color: #f9f9f9; padding: 150px 0;" data-stellar-background-ratio="0.3">
                        ...
                        <div class="container clearfix">
                            ...
                            <div class="col_two_fifth nobottommargin">
                                <img src="images/sneco/logo/sneco_logo.png"/>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-6" style="background-color: #F5F5F5;">
                            <div class="col-padding max-height">
                                ...
                                <div style="font-size: 16px; line-height: 1.7;">
                                    ...
                                    <abbr title="Phone Number"><strong>Phone:</strong></abbr> +31657966657<br>
